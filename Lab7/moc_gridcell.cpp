...
**
** Created: Fri Oct 29 12:19:34 2010
...
static const char qt_meta_stringdata_GridCell[] = {
    "GridCell\0\0type\0typeChanged(CellState)\0"
    "handleClick()\0setType(CellState)\0"
};
...
int GridCell::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: typeChanged((*reinterpret_cast< CellState(*)>(_a[1]))); break;
        case 1: handleClick(); break;
        case 2: setType((*reinterpret_cast< CellState(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 3;
    }
...
// SIGNAL 0
void GridCell::typeChanged(CellState _t1)
{
